...
=== From local
  ...
  git tag -d v2024.3.15

=== From remote

  git push -d origin v2024.3.15
...
#
  git tag -a v2024.3.15 -m "v2024.3.15"
  git push --tags
...
git commit -am "New version 2024.3.15"
git commit --allow-empty -m "New version 2024.3.15"
git commit -am "Prepare new version 2024.3.15"

git commit -am "Latest files of version 2024.3.15"

git commit -am "Latest posts of version 2024.3.15"
git commit -am "Latest articles of version 2024.3.15"
