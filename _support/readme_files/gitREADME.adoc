...
#
  git tag -a v2024.2.1 -m "v2024.2.1"
  git push --tags
...
git commit -am "New version 2024.2.1"
git commit --allow-empty -m "New version 2024.2.1"
git commit -am "Prepare new version 2024.2.1"

git commit -am "Latest files of version 2024.2.1"

git commit -am "Latest posts of version 2024.2.1"
git commit -am "Latest articles of version 2024.2.1"
