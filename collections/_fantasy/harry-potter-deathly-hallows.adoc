...
image:
  path:                                 /assets/images/collections/books/fantasy/harry-potter-deathly-hallows.jpg

book:
  cover:                                /assets/images/collections/books/fantasy/harry-potter-deathly-hallows.jpg
  format:                               paperback
  pages:                                640
