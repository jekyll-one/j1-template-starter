# ------------------------------------------------------------------------------
# ~/_plugins/asciidoctor-extensions/lightbox3-block.rb
...
#
#   .block_title
#   lightbox3::block_id[images_width, images_data]
#
# Example:
#
#  .The image block title
#  lightbox3::lightbox-example[450, "assets/image/module/gallery/old_times/image_01.jpg, description 1, assets/image/module/gallery/old_times/image_02.jpg, description 2" ]
#
# ------------------------------------------------------------------------------
include Asciidoctor
...
Asciidoctor::Extensions.register do
  ...
  class Lightbox3BlockMacro < Extensions::BlockMacroProcessor
    use_dsl
  ...
  block_macro Lightbox3BlockMacro
end
