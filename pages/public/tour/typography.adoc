...
Have you enjoyed working with the text? The J1 template can do even more
for your web pages. On the next page, you’ll see examples of how icons can
add meaning to your content. J1 Template works with popular icon font sets
right away. The MDI and FA icon sets are well-designed and offer a wide
variety of icons for many web uses.
