  ...
  <div class="modal-dialog modal-side modal-top-right modal-notify modal-success" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p id="successModalLabel" class="modal-title lead mb-3" style="font-size: 1.5rem;font-weight: 400;">Modal Success</p>
        <button id="closeSuccessModal" type="button" class="btn-close mb-3" data-bs-dismiss="modal" aria-label="Close">
        </button>
      </div>
...
<div id="sideModalTLInfoDemo"
  ...
  <div class="modal-dialog modal-side modal-top-left modal-notify modal-info" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p id="infoModalLabel" class="modal-title lead mb-3" style="font-size: 1.5rem;font-weight: 400;">Modal Info</p>
        <button id="closeInfoModal" type="button" class="btn-close mb-3" data-bs-dismiss="modal" aria-label="Close">
        </button>
      </div>
...
<div id="sideModalBRDangerDemo"
  ...
  <div class="modal-dialog modal-side modal-bottom-right modal-notify modal-danger" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p id="dangerModalLabel" class="modal-title lead mb-3"
        style="font-size: 1.5rem;font-weight: 400;">Modal Danger</p>
...
<div id="sideModalBLWarningDemo"
  ...
  <div class="modal-dialog modal-side modal-bottom-left modal-notify modal-warning" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p id="warningModalLabel" class="modal-title lead mb-3"
        style="font-size: 1.5rem;font-weight: 400;">Modal Warning</p>
        <button id="closeWarningModal" type="button" class="btn-close mb-3" data-bs-dismiss="modal" aria-label="Close">
        </button>
      </div>      
...
<div id="fluidModalRightSuccessDemo"
  ...
  <div class="modal-dialog modal-full-height modal-right modal-notify modal-success" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p id="successModalLabel2" class="modal-title lead mb-3"
        style="font-size: 1.5rem;font-weight: 400;">Modal Success</p>
        <button id="closeSuccessModal2" type="button" class="btn-close mb-3" data-bs-dismiss="modal" aria-label="Close">
        </button>
      </div> 
...
<div id="fluidModalLeftInfoDemo"
  ...
  <div class="modal-dialog modal-full-height modal-left modal-notify modal-info" role="document">
    ...
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header">
        <p id="infoModalLabel2" class="modal-title lead mb-3"
        style="font-size: 1.5rem;font-weight: 400;">Modal Info</p>
        <button id="closeInfoModal2" type="button" class="btn-close mb-3" data-bs-dismiss="modal" aria-label="Close">
        </button>
      </div>       
