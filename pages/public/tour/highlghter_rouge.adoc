...
The search module *site_search* for J1 Template is based on _Lunr_, a
...
Using the search module *site_search* for J1 based websites, it is *not*
...
link:{url-tour--site_search}[Search Engine].
