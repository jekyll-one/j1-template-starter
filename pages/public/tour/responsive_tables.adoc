...
The J1 Template offers many features other Jekyll templates do not. *Themes*
are one of them. A *theme* is a set of styles -- a *skin* -- that changes
the look of your whole website at once. J1 themes are based on *Bootstrap*
(version 5). Using a theme ensures your site looks consistent across every
page and modern browser: the same fonts, colors, table styles, and form
elements everywhere. You can also use the built-in Bootstrap CSS classes
to fine-tune the design yourself.
