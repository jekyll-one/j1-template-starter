...
A J1 Gallery is a collection of images (or videos) displayed together. It
helps display products, portfolios, or events in a visually appealing,
easy-to-explore way. Visitors can view, zoom in, or swipe through the visuals,
making the experience more engaging.

Find examples of available galleries suppoerted by J1-Template: 

* **Grid**-styled Galleries
* **Masonry**-styled Galleries

The difference between a **Grid**-styled gallery and a **Masonry**-styled
gallery is how they handle image height and alignment. While a *grid* forces
a *uniform structure*, *masonry* allows images to retain their natural
proportions, creating a *brick wall* effect. 
