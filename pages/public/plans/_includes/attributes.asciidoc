...
:data-site_search-icon:                           "pages/roundtrip/600_site_search/site_search_icon-800x200.jpg, Search button (magnifier) in the quick access area"
:data-site_search-input:                          "pages/roundtrip/600_site_search/site_search_input-800x200.jpg, Input bar for a site_search"
