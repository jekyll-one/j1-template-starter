...
description: >
                                        The J1 Template uses a set of colors based on Google's
                                        Material Design. It comes with main colors and accent
                                        colors that you can use for pictures or to build your own
                                        website brand colors. The colors are picked to look good
                                        together.
keywords: >
...
image:
  path:                                 /assets/image/module/attic/1920x1280/mika-baumeister.jpg
  width:                                1920
  height:                               1280
...
regenerate:                             false
permalink:                              /pages/public/tools/previewer/color_palette/

resources:                              []
resource_options:
  - attic:
      slides:
        - url:                          /assets/image/module/attic/1920x1280/mika-baumeister.jpg
          alt:                          Photo by Mika Baumeister on Unsplash
          badge:
            type:                       unsplash
            author:                     Mika Baumeister
            href:                       //unsplash.com/de/@kommumikation
---
...
// -----------------------------------------------------------------------------
[role="dropcap"]
The colors used in the J1 Template come from Google's *Material Design* (MD).
The set has main colors and accent colors. You can use them for pictures
or to make your own website brand colors. They are picked to look good
together.

//gad::ad_7522184684["mt-5 mb-5"]

The color set begins with main colors and adds extra shades to give you a
full set that works for both desktop and mobile websites on Android or
iOS. Google suggests you use the *500* shade as your main color, and the
other shades as accents that highlight your content for easier reading
...
== Red and Pink
++++
<div class="color-palette" style="grid-template-columns: repeat(2, 1fr);">
...
/* color previewer page #1: CSS grid for color-palette (mirrors #playlistHistory pattern) */
/* grid-template-columns is set inline (repeat(2, 1fr)) so the value is */
/* visible at the markup level, just like on #playlistHistory.          */
.color-palette {
  display: grid;
  gap: 1rem;
}

/* color previewer page #1: collapse to a single column below Bootstrap's lg breakpoint */
/* preserves the responsive behaviour of the original col-lg-6 layout */
...
.color-palette > .color-group {
  min-width: 0; /* prevent grid blow-out from long inline content */
}
