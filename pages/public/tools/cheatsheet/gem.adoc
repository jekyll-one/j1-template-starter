...
[source, sh]
----
gem install j1-template -v 2023.4.0 --user-install --no-document
----
...
[source, sh]
----
gem install j1-template -v 2023.4.0 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
----
