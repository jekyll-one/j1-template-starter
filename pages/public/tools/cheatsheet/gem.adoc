...
[source, sh]
----
gem install j1-template -v 2023.5.2 --user-install --no-document
----
...
[source, sh]
----
gem install j1-template -v 2023.5.2 --source 'https://gem.fury.io/jekyll-one-org/' --user-install --no-document
----
